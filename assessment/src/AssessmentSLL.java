...
public class AssessmentSLL<E extends Comparable<E>> {
    ...
    public AssessmentSLL<E> merge(AssessmentSLL<E> list1, AssessmentSLL<E> list2) {
        AssessmentSLL<E> firstTwoLists = mergeTwoLists(list1, list2);
        return mergeTwoLists(firstTwoLists, this);
    }

    public AssessmentSLL<E> mergeTwoLists(AssessmentSLL<E> list1, AssessmentSLL<E> list2) {
